...
export default function SubmitExpenseScreen() {
  ...
  const handleSubmit = async () => {
    ...
    if (!purpose.trim() || !name.trim() || !date) {
      Alert.alert("Missing Information", "Please fill in the purpose and your name.");
      return;
    }
    ...
    try {
      ...
      Alert.alert("Submission Failed", "There was an error saving your expense.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
      ...
      <View style={styles.formContainer}>
        ...
        <View style={styles.imageSection}>
          <TouchableOpacity style={styles.imagePicker} onPress={pickBusinessCard}>
            <Text style={styles.imagePickerText}>
              {businessCard ? "Change Business Card" : "Attach Business Card"}
            </Text>
          </TouchableOpacity>
          {businessCard && <Image source={{ uri: businessCard }} style={styles.previewImage} />}
        </View>
        ...
        <TouchableOpacity 
          ...
          disabled={loading}
        >
          <Text style={styles.buttonText}>{loading ? "Submitting..." : "Submit Entry"}</Text>
        </TouchableOpacity>
      </View>
    </ScrollView>
  );
